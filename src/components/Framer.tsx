...
export default function Farmer() {
  return (
    <AnimateSharedLayout>
      <motion.ul className="farmer_animate" layout initial={{ borderRadius: 25 }}>
        {items.map(item => (
          <Item key={item} />
        ))}
      </motion.ul>
...
function Item() {
  ...
  return (
    <motion.li layout className="farmer" onClick={toggleOpen} initial={{ borderRadius: 10 }}>
